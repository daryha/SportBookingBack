...
namespace BookingSports.Migrations
{
    ...
    [Migration("20250414134010_InitialCreate")]
            ...
            modelBuilder.Entity("BookingSports.Models.Schedule", b =>
                {
                    ...
                    b.Property<string>("SportFacilityId1")
                        .HasColumnType("text");

                    b.Property<string>("SportFacilityId2")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("SportFacilityId1");

                    b.HasIndex("SportFacilityId2");
            ...
            modelBuilder.Entity("BookingSports.Models.Schedule", b =>
                {
                    ...
                    b.HasOne("BookingSports.Models.SportFacility", null)
                        .WithMany("Schedule")
                        .HasForeignKey("SportFacilityId1");

                    b.HasOne("BookingSports.Models.SportFacility", null)
                        .WithMany("Schedules")
                        .HasForeignKey("SportFacilityId2");
